...
% --- badges de robustez ---
\node[badge, below=1.5cm of det, xshift=-3.5cm] (b1) {\textbf{SSTN}: recentra la silueta si la caja se desvió};
...
\node[font=\sffamily\scriptsize\bfseries, text=DarkBlue] at ($(b1.north west)+(-1.3,0.2)$) [anchor=west]
