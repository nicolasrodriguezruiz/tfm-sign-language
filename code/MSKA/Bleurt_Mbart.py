...
def main():
    config_path = ''
    checkpoint_path = ''
    csv_output_path = 'resultados_mbart_test_s2t.csv'
    ...
    # =====================================================================
    # INFERENCIA (MBART) -> Extraer Traducciones
    # =====================================================================
    print("\n" + "="*50)
    print("INFERENCIA S2T CON MBART")
    print("="*50)
    ...
    # Cargar Modelo
    print("[2/3] Cargando Modelo de Traducción (MBart)")
    ...
    with torch.no_grad():
        for batch in tqdm(test_dataloader, desc="Traduciendo"):
            ...
            # Forward pass para obtener features del encoder visual
            output = model(batch)

            # Generar texto usando el decodificador MBart
    ...
    print(f"\n Predicciones de MBart guardadas exitosamente en: {csv_output_path}")
