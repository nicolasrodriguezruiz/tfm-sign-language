...
Scaling to 7B parameters yields BLEU-4 of $20.03$ BLEU-4 under a more constrained fine-tuning budget.
...
Contrary to expectations, the instruction prompt is found to be detrimental during fine-tuning, as visual tokens and textual instructions compete for the model's attention.
...
Escalar a 7B de parámetros produce un BLEU-4 de 20.03 bajo un presupuesto de ajuste fino más restringido.
...
Contrario a las expectativas, se observa que el \textit{prompt} de instrucción resulta perjudicial durante el ajuste fino, ya que los \textit{tokens} visuales y las instrucciones textuales compiten por la atención del modelo.
...
\newpage
\mbox{}
TODO: EConclusión y trabajo futuro
\thispagestyle{empty}
\newpage
