...
%     inner frame sep=0pt, % <--- ¡ESTA LÍNEA ELIMINA EL MARGEN EXTRA!
    ...
    \node[color_tinta] (titulo) {\underline{\textbf{PE espacial}}};
    ...
    \node[mathnode, right=-0.25cm of x1_add, color_tinta] (vec1) {$\begin{bmatrix} 1 \\ 2 \\ 3 \end{bmatrix}$};
    ...
    \node[mathnode, right=-0.25cm of x2_add, color_tinta] (vec2) {$\begin{bmatrix} 1 \\ 2 \\ 3 \end{bmatrix}$};

    % 4. Nota explicativa lateral
    \node[texto, right=2.5cm of vec1, yshift=-0.4cm, color_tinta] (nota) {Mismo \textit{keypoint} \\ misma\\ codificación posicional};
